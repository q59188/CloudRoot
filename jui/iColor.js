    ...
    $(function () {
        ...
        $iColor = $('<div id="iColorPicker"><table class="pickerTable"><thead></thead><tbody><tr><td colspan="16" id="colorPreview"></td></tr></tbody></table></div>').css({
            ...
            var group = [], row = '', hx = [
                    ...
                    //
                    'FF0000', 'F07800', '008000', '0000FF', 'FF00FF', 'A52A2A', '6C6C00', 'C0B800', '800080', '00CCCC', 'F0F0F0', 'C8C8C8', '800000', '707070', 'a04040', '303030'
                ];
            
            $.each(hx, function(num, color) {
                row += '<td style="background:#' + color + ';min-width:1em;cursor:pointer;" hx="' + color + '">&nbsp;&nbsp;</td>';
                if (num % 16 == 15) {
